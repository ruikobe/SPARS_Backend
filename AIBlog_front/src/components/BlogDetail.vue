  ...
  <el-row v-loading="loading">
    <el-col :span="24">
      <div style="text-align: left;">
        <el-button type="text" icon="el-icon-back" @click="goBack" style="padding-bottom: 0px;">Return</el-button>
      </div>
    </el-col>
    <el-col :span="24">
      <div>
        ...
        <div style="width: 100%;margin-top: 5px;display: flex;justify-content: flex-end;align-items: center">
          ...
          <span style="color: #20a0ff;margin-right:20px;font-size: 12px;">Browse {{article.pageView==null?0:article.pageView}}</span>
